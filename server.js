...
app.post("/api/send-shopping-list", async (req, res) => {
  ...
  const html = `
    <!DOCTYPE html><html><body style="margin:0;padding:0;background:#f2f2f7;font-family:-apple-system,BlinkMacSystemFont,'Helvetica Neue',sans-serif;">
    <div style="max-width:600px;margin:0 auto;background:#fff;border-radius:16px;overflow:hidden;margin-top:24px;">
      <div style="background:linear-gradient(135deg,#007aff,#34c759);padding:32px 28px;">
        <img src="https://www.leanplan.uk/email-header.png" alt="LeanPlan" style="height:36px;margin-bottom:16px;display:block;" />
        <h1 style="color:#fff;font-size:22px;font-weight:700;margin:0 0 6px;">Your Shopping List</h1>
        <p style="color:rgba(255,255,255,0.85);font-size:14px;margin:0;">${planDays}-day meal plan · ${categories.reduce((a,c)=>a+c.items.length,0)} items</p>
      </div>
      ...
      <div style="padding:16px 28px 28px;text-align:center;color:#8e8e93;font-size:12px;">
        Generated by LeanPlan · <a href="https://www.leanplan.uk" style="color:#007aff;">leanplan.uk</a>
      </div>
    </div>
    </body></html>
  `;
