import { TRIAL_DAYS, PACE_OPTIONS } from "../constants/config.js";
...
export const setTrialStart = () => {
  if (!getTrialStart()) localStorage.setItem("leanplan_trial_start", new Date().toISOString());
};
