...
const PaywallModal = ({ onClose }) => {
  ...
  return (
    <div style={{ position:"fixed", inset:0, zIndex:1000, display:"flex", flexDirection:"column", justifyContent:"flex-end" }}>
      ...
      {/* Sheet */}
      <div style={{ position:"relative", background:C.bg, borderRadius:"24px 24px 0 0", padding:"24px 20px calc(40px + env(safe-area-inset-bottom))", height:"96vh", overflowY:"auto" }}>
        {/* Handle */}
