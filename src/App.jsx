...
import { MealsTab } from "./components/MealsTab/index.jsx";
import { TrainTab } from "./components/TrainTab/index.jsx";
import { TrackTab } from "./components/TrackTab/index.jsx";
import { CoachTab } from "./components/CoachTab/index.jsx";
import { ProfileTab } from "./components/ProfileTab/index.jsx";
import { PaywallModal, WelcomeScreen, AuthScreen, CreateAccountScreen, TrialExpiredScreen, WeeklyCheckIn, ProBanner, LockedTab, ErrorBoundary } from "./components/screens/index.jsx";

// ── MAIN ──────────────────────────────────────────────────────────────────────
function AppInner() {
  const { C, isDark, darkOverride, setDarkOverride } = useTheme();
  // RESET_KEYS imported from constants/config.js
  ...
  // darkOverride managed by ThemeContext
  // Auth state
  ...
  const loadBg = isDark ? "#000" : "#f2f2f7";
  const loadText = "#8e8e93";
  ...
  // isDark and C from ThemeContext
